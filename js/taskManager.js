    ...
    render (){
        ...
        for  (let i=0; i<this.tasks.length;i++){
          ...
          // looping and storing in task variable
           ...
           const taskHtml = createTaskHtml(this.tasks[i].id, this.tasks[i].name, this.tasks[i].description, this.tasks[i].assignedTo, this.tasks[i].dueDate, this.tasks[i].staus);
